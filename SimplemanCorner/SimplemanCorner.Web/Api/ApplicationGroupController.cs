...
using SimplemanCorner.Common.Exceptions;
using SimplemanCorner.Data.Infrastructure;
using SimplemanCorner.Model.Models;
using SimplemanCorner.Service;
using SimplemanCorner.Web.App_Start;
using SimplemanCorner.Web.Infrastructure.Core;
using SimplemanCorner.Web.Infrastructure.Extensions;
using SimplemanCorner.Web.Models;
using simplemancorner.Web.Infrastructure.Core;

namespace SimplemanCorner.Web.Api
{
